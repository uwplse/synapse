...
(require
  ...
  "../benchmarks/parrot/fft.rkt" "../opsyn/engine/solver+.rkt"
...
(define/provide-test-suite fft-tests
  (test-no-search (fft-sin-metasketch) 'fft-sin '(1 1))
  (test-no-search (fft-cos-metasketch) 'fft-cos '(1 1)))

(run-tests-quiet fft-tests)
